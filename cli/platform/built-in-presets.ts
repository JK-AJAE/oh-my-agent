...
export const BUILT_IN_PRESETS: Record<BuiltInPresetKey, ModelPreset> = {
  ...
  claude: {
    ...
    agent_defaults: {
      ...
      refactor: { model: "anthropic/claude-sonnet-4-6" },
  ...
  codex: {
    ...
    agent_defaults: {
      ...
      refactor: { model: "openai/gpt-5.5", effort: "high" },
  ...
  qwen: {
    ...
    agent_defaults: {
      ...
      refactor: { model: "qwen/qwen3.6-plus", thinking: true },
  ...
  kiro: {
    ...
    agent_defaults: {
      ...
      refactor: { model: "kiro/claude-sonnet-4-5" },
  ...
  cursor: {
    ...
    agent_defaults: {
      ...
      refactor: { model: "cursor/composer-2.5" },
