...
## [9.0.0](https://github.com/JK-AJAE/oh-my-agent/compare/cli-v8.16.0...cli-v9.0.0) (2026-05-29)
...
* add Cursor plugin manifest for marketplace support ([878735b](https://github.com/JK-AJAE/oh-my-agent/commit/878735b7e3463b45273e6e81de5812571dd04d44))
* add first-class Grok support ([cb57928](https://github.com/JK-AJAE/oh-my-agent/commit/cb5792813c34c799455fa37bb0e97088cd8ee889))
* add L1 state hooks ([5367519](https://github.com/JK-AJAE/oh-my-agent/commit/5367519687ae079ae4d328ad40eca2d929e49764))
* add telemetry opt-in to oma-config for all vendors ([22265cd](https://github.com/JK-AJAE/oh-my-agent/commit/22265cd913310693418cfb1d04cdeaf04f00ecd5))
* **agent:spawn:** expose --isolation=worktree for per-spawn git worktree ([8e5ebf5](https://github.com/JK-AJAE/oh-my-agent/commit/8e5ebf5a53aa53c7cdba59351850de41c8db6b38))
* **agents:** add docs-curator agent for orchestrated docs sync ([e5ffa5b](https://github.com/JK-AJAE/oh-my-agent/commit/e5ffa5b2d3a2a878a3ddb26c93b5e071e9c66849))
* **antigravity:** agy mcp_config.json compatibility ([0099f2c](https://github.com/JK-AJAE/oh-my-agent/commit/0099f2cf82aebe1a2a9f6d8f8b13b08b6d61eae3))
* **benchmarks:** add multi-judge averaging for spec and visual axes ([c1c0f74](https://github.com/JK-AJAE/oh-my-agent/commit/c1c0f7472ec019c6b21510796e8a050f75433635))
* **claude:** add skillListingBudgetFraction to recommended settings ([8fdf933](https://github.com/JK-AJAE/oh-my-agent/commit/8fdf9336714330d41ce571e91b22df35a8f4bf97))
* **cli:** add antigravity (agy) as first-class vendor ([715e7b1](https://github.com/JK-AJAE/oh-my-agent/commit/715e7b1c24d5b67376edb4af0b0084544efcaff4))
* **cli:** add model:check, model:probe, model:propose commands ([abd74fb](https://github.com/JK-AJAE/oh-my-agent/commit/abd74fbb2dc7974a2818094c522f65ad7e115837))
* **cli:** add TF-IDF cross-skill boundary audit ([086bfbe](https://github.com/JK-AJAE/oh-my-agent/commit/086bfbe1ff35ba97e7288956d5f923c512d4fc52))
* **cli:** align Cursor Agent auth, models, and dispatch ([2dfc258](https://github.com/JK-AJAE/oh-my-agent/commit/2dfc25866f705ac3c1f501c98131eecd6ea5db3d))
* **cli:** auto-register skills from .agents/skills/ frontmatter ([050f16f](https://github.com/JK-AJAE/oh-my-agent/commit/050f16fd40cda809fa83d19aed6a06edb8b3e45f))
* **cli:** expand install presets with web/mobile/research/content ([06a8c64](https://github.com/JK-AJAE/oh-my-agent/commit/06a8c6406f6d5e618bdb071e8f98ca0614fd9af2))
* **cli:** ingest Cursor transcripts and harden recap dashboard ([21f45a5](https://github.com/JK-AJAE/oh-my-agent/commit/21f45a5dea50ea9c3c7f437070d809a713266a06))
* **cli:** preserve user-upgraded effortLevel in claude settings ([4e0f50f](https://github.com/JK-AJAE/oh-my-agent/commit/4e0f50f52f47e138587f86dc9063fc88daba8c2a))
* **cli:** show added/removed skills and workflows on update ([c03baf9](https://github.com/JK-AJAE/oh-my-agent/commit/c03baf9f168037f302b32d70b0924ee59fdad828))
* **cli:** warn when oma-config targets the deprecated Gemini CLI ([11c5e28](https://github.com/JK-AJAE/oh-my-agent/commit/11c5e2882c741081026ea02b512bbbf848023e72))
* **cursor:** promote cursor to first-class vendor ([12a3c3d](https://github.com/JK-AJAE/oh-my-agent/commit/12a3c3d823829cbfa901accbb8480864e34e0b58))
* **docs:** add 'oma docs i18n' for translation drift detection ([19c2efb](https://github.com/JK-AJAE/oh-my-agent/commit/19c2efb719cc38e600241f968490ab2d7c3738cd))
* **docs:** add 'oma docs lint' for i18n style anti-patterns ([048804d](https://github.com/JK-AJAE/oh-my-agent/commit/048804d2210152c46dcf841ef64248f847686e81))
* **docs:** introduce oma-docs verify and sync skill ([#326](https://github.com/JK-AJAE/oh-my-agent/issues/326)) ([dc18e83](https://github.com/JK-AJAE/oh-my-agent/commit/dc18e83f30a010812577bb83ff56b6990fb786b7))
* **docs:** swap tinyld for eld and add wrong-language rule ([89855df](https://github.com/JK-AJAE/oh-my-agent/commit/89855dfbcd9ce38fc1008bef4ada45a84bccc632))
* **doctor,memory:** extend vendor doc checks and add memory CLI commands ([a2f22a7](https://github.com/JK-AJAE/oh-my-agent/commit/a2f22a7cd7e03ef2dd97f62184f88e6ac5157626))
* **doctor:** dual-install presence + legacy backfill hint ([b628353](https://github.com/JK-AJAE/oh-my-agent/commit/b628353af565792e4bb87c7b7fbd658b83e872d8))
* **hooks:** add intent regex patterns and sanitize hardening ([f5800e1](https://github.com/JK-AJAE/oh-my-agent/commit/f5800e1e34493ead0b3dfb6aa594e2400623c57b))
* **hooks:** resolve unknown slash commands via hidden skill lookup ([ef15f15](https://github.com/JK-AJAE/oh-my-agent/commit/ef15f15ab340d4b0909135b3a81048e3b8e447f3))
* **hud:** wire HUD for Gemini CLI and Antigravity (agy) ([598e20b](https://github.com/JK-AJAE/oh-my-agent/commit/598e20bbb06134c24c64a80a3695b14b14d69ebd))
* **image:** allow arbitrary WxH sizes within gpt-image-2 limits ([2acef68](https://github.com/JK-AJAE/oh-my-agent/commit/2acef685c7715e8f83e638d4f2a1c9e9b79ee3eb))
* **image:** replace gemini vendor with keyless antigravity (agy) ([1d23e5a](https://github.com/JK-AJAE/oh-my-agent/commit/1d23e5a0ab6e8f91057ca1eca1a431bbc9b736eb))
* **install:** --global mode + context singleton + lock + guards + i18n + hook dedup ([36220f6](https://github.com/JK-AJAE/oh-my-agent/commit/36220f68ca011a43e5ddbdc3d83b391ea801716e))
* **install:** ensure docs/generated/ is gitignored after install ([37b9b67](https://github.com/JK-AJAE/oh-my-agent/commit/37b9b678d0f835176d12793705708851ec6e4091))
* **installer:** auto-install serena via uv tool on windows ([cff9c21](https://github.com/JK-AJAE/oh-my-agent/commit/cff9c215c48eadc23aad0cf178e010f4d78851e9))
* **io:** add gitignore module and auto-ignore docs/generated ([f033332](https://github.com/JK-AJAE/oh-my-agent/commit/f033332b7c49fedb49189713fea5d1f462ed161f))
* **market:** add discover-competitors (LLM-first peer-entity candidates) ([e19ee27](https://github.com/JK-AJAE/oh-my-agent/commit/e19ee27001dd8bafc8b988141a4763868a8fa23f))
* **market:** add oma-market skill with deterministic CLI pipeline ([3d42406](https://github.com/JK-AJAE/oh-my-agent/commit/3d4240661aa3b202e660099c44a4d35245455122))
* **memory:** add AgentMemory setup and daemon commands ([10b846a](https://github.com/JK-AJAE/oh-my-agent/commit/10b846ae3b1267b6756c7a3a080379b1a08cccc3))
* **memory:** import vendor history into AgentMemory ([e75aaaf](https://github.com/JK-AJAE/oh-my-agent/commit/e75aaafdd2bc4932d00d75eea8b2aefb35140f47))
* **memory:** install AgentMemory service during setup ([c5a6462](https://github.com/JK-AJAE/oh-my-agent/commit/c5a646285451879c7fa24b47c3b5220ca624b002))
* **memory:** manage AgentMemory service lifecycle ([c274ab5](https://github.com/JK-AJAE/oh-my-agent/commit/c274ab5b8bc037b647f11bfcda798154c59fa027))
* **meta:** merge install state into _version.json (schemaVersion=2) ([72f3d20](https://github.com/JK-AJAE/oh-my-agent/commit/72f3d20ecb6a275ea8f5ff424092e015cd0f97e2))
* **migrations:** add 010-rename-preset-keys auto-migration ([2c6724c](https://github.com/JK-AJAE/oh-my-agent/commit/2c6724c8c0b41845d63762bf15b864a83a796262))
* **observability:** add WAF rule observability page ([07607ed](https://github.com/JK-AJAE/oh-my-agent/commit/07607ed4a56594d4bc553d90b3e03621e120cb52))
* **oma-db:** add verification discrepancy audit guidance ([16a8130](https://github.com/JK-AJAE/oh-my-agent/commit/16a8130a47406e9817d447d8c8822c989cdeaaf1))
* **oma-slide:** add Canva MCP integration and auto-provisioning ([fc2c599](https://github.com/JK-AJAE/oh-my-agent/commit/fc2c5993207ee513aa12a81ffcffaf3b0a473c13))
* **oma-translator:** add tailing-negation rule and curly-quote check ([0697d6a](https://github.com/JK-AJAE/oh-my-agent/commit/0697d6a8e82c0aa856f8c17b5a7b97905a365e75))
* **platform:** harden createLink with SSOT validation and Win32 long-path ([cda3424](https://github.com/JK-AJAE/oh-my-agent/commit/cda342471ac1b8f20c585a5629586f97e1093542))
* **readme:** add 'Works With Every Agent' vendor logos table ([e8b4211](https://github.com/JK-AJAE/oh-my-agent/commit/e8b42113493f4e03f65979667dde93a48d0af518))
* **recap:** add antigravity parser and extract shared parser utils ([d314a20](https://github.com/JK-AJAE/oh-my-agent/commit/d314a20dc0d5e5145649c78dd12413865965e690))
* **rules:** add serena MCP code-search guidance to vendor docs ([8ae45f9](https://github.com/JK-AJAE/oh-my-agent/commit/8ae45f995864620269a6d3b41a3ea7a117b1500f))
* **scripts:** add sns:devto weekly draft generator ([e47f72c](https://github.com/JK-AJAE/oh-my-agent/commit/e47f72c520b35db2a8670d35414d4e06b31e8590))
* **search:** add clien, okky, duckduckgo (ddgs) handlers ([09bfbb4](https://github.com/JK-AJAE/oh-my-agent/commit/09bfbb434a3be82963c2a73d783b2c5ee389a23c))
* **serena:** apply Claude .mcp.json and Gemini bridge override in oma update ([ad8d7d6](https://github.com/JK-AJAE/oh-my-agent/commit/ad8d7d6a62fb109de4aa044ffabbc1e88b467b26))
* **serena:** migrate to uv tool install with per-vendor MCP contexts ([d79e51d](https://github.com/JK-AJAE/oh-my-agent/commit/d79e51dbd44362f18bd7e2978a163e026cfa94b6))
* **serena:** opt-in serena-agent auto-upgrade during oma update ([c0e42d6](https://github.com/JK-AJAE/oh-my-agent/commit/c0e42d6b2bb5c641056aae6d9839e29e4cbd154a))
* **skills/oma-frontend, benchmarks:** teach React 19 hook anti-patterns, refresh oma run ([91de585](https://github.com/JK-AJAE/oh-my-agent/commit/91de585943b96ee708272b93d4e2f8804030b343))
* **skills:** add oma-academic-writer for academic prose ([8369a4c](https://github.com/JK-AJAE/oh-my-agent/commit/8369a4cc6db6406c4537b8ec6c64b10c216041c8))
* **skills:** add oma-deepsec skill and /deepsec workflow ([56eb571](https://github.com/JK-AJAE/oh-my-agent/commit/56eb571e92df7b48b27f7fa89678cad169fa4d22))
* **skills:** domain-gated exposure + structured outputs schema ([52f0d31](https://github.com/JK-AJAE/oh-my-agent/commit/52f0d31f3b8b23c831d7f1128ce429fbd5ed29fe))
* **skills:** strengthen oma-frontend + backend rules for benchmark gaps ([c384fd0](https://github.com/JK-AJAE/oh-my-agent/commit/c384fd0cf8d10af24ebeef49c723a9063bfe0f85))
* **skills:** unify workflow skills under .agents/skills/ SSOT (Migration 011) ([757d697](https://github.com/JK-AJAE/oh-my-agent/commit/757d697f6340519b1921d7c49b8b5b1b69c7289a))
* **slide:** add oma-slide deck toolkit (skill + CLI) ([a41c852](https://github.com/JK-AJAE/oh-my-agent/commit/a41c8524f01f05438dcd456473805096fe8c9ab0))
* **slide:** add print support and improve local CSS scoping ([613da42](https://github.com/JK-AJAE/oh-my-agent/commit/613da4270903723abbe1087877f5eb298c541688))
* **state:** add AgentMemory observe provider ([#433](https://github.com/JK-AJAE/oh-my-agent/issues/433)) ([1bb811a](https://github.com/JK-AJAE/oh-my-agent/commit/1bb811a49222f6e07f4c4a0cbecd6712b709398b))
* **state:** enforce L1 decision snapshots ([203ddfb](https://github.com/JK-AJAE/oh-my-agent/commit/203ddfb13ee54c8e06c672b681c5015be1210fe2))
* **stats:** surface session-cost telemetry with vendor breakdown and USD estimate ([c31778d](https://github.com/JK-AJAE/oh-my-agent/commit/c31778d3224efaf5c5933acb6b1e161aa80ad2e8))
* **translator:** add Diff-Sync Mode to oma-translator skill ([6647b9a](https://github.com/JK-AJAE/oh-my-agent/commit/6647b9abcc53ca0492d6fca9cdecaa0f3c52d0bc))
* **translator:** add humanizer-aware voice sample calibration ([6ff9f37](https://github.com/JK-AJAE/oh-my-agent/commit/6ff9f374b346b45873f4db7971fda9bfd7f6ac46))
* **uninstall:** add oma uninstall [--global] with dry-run preview ([ffb2bd5](https://github.com/JK-AJAE/oh-my-agent/commit/ffb2bd538ed52dc52cb17ca5f34fbee938e885a0))
* **utils:** add safeWriteJson + safeReadJson with vendor-file guard ([a6dd155](https://github.com/JK-AJAE/oh-my-agent/commit/a6dd1555cbcedf87c6c617e0a855fb123ce847a6))
* **vault:** os-keychain credential store via @napi-rs/keyring ([ec33b53](https://github.com/JK-AJAE/oh-my-agent/commit/ec33b53d5f88059ba7bc8e4ae60962b9f642dd4f))
* **verify:** add closure check via structured Expected outputs ([7ab4b51](https://github.com/JK-AJAE/oh-my-agent/commit/7ab4b51f6052b53a527c58359d5a5be5033b2e36))
* **voice:** add oma-voice skill for local TTS/STT via Voicebox MCP ([3a0a7fb](https://github.com/JK-AJAE/oh-my-agent/commit/3a0a7fb48c2ecbed80a425d837fa0a93f0e13dc8))
* **web:** enable PWA via @docusaurus/plugin-pwa ([da1362e](https://github.com/JK-AJAE/oh-my-agent/commit/da1362e39423de6998ec85272c5975fcea859762))
* **workflows:** add /docs workflow wrapping oma-docs ([5512629](https://github.com/JK-AJAE/oh-my-agent/commit/5512629ab66edc09dffab80d83fff16ed514e561))
* **workflows:** add recap workflow for oma-recap ([1d328ef](https://github.com/JK-AJAE/oh-my-agent/commit/1d328ef4c539d9cb695a34c84ec37a6f445584ec))
* **workflows:** bias brainstorm and work loops toward structural fixes ([50ce165](https://github.com/JK-AJAE/oh-my-agent/commit/50ce16541b2aa2fba9d6bbe9319a4497d56ca609))


### Bug Fixes

* **benchmarks:** build-report gallery row fuzzy match ([fcd67ed](https://github.com/JK-AJAE/oh-my-agent/commit/fcd67ed834d85b9bbdbffb2d89fc6e49699cbb8a))
* **benchmarks:** drop gradient hero text in oma landing ([c9f6e13](https://github.com/JK-AJAE/oh-my-agent/commit/c9f6e136558e8dda3d4d816deb2ad1c0f222ede2))
* **ci:** also pass NPM_CONFIG_TOKEN to bun publish ([0e51b8e](https://github.com/JK-AJAE/oh-my-agent/commit/0e51b8e2e5cc09193b064122e2d2e1e4e9c04980))
* **ci:** prevent sync-manifest race conditions with concurrency and retry ([dc03410](https://github.com/JK-AJAE/oh-my-agent/commit/dc03410e90775ebc23cf73d2dc23158ed3793a36))
* **ci:** use NODE_AUTH_TOKEN for bun publish auth ([44e7824](https://github.com/JK-AJAE/oh-my-agent/commit/44e7824b08f313065da01e0ba0ba5359cc951e3c))
* **cli:** normalize Windows paths in docs resolver and self-update ([6345f36](https://github.com/JK-AJAE/oh-my-agent/commit/6345f36b6bc13fc1ba835c8fd159d0e7b9576a53))
* **cli:** retry rmSync in update-cursor test to dodge Windows EBUSY ([8a2a7d7](https://github.com/JK-AJAE/oh-my-agent/commit/8a2a7d7736bdceb417c4a89489167f5619543801))
* **cli:** use platform separator in isInIgnoredSet for Windows ([e4945b1](https://github.com/JK-AJAE/oh-my-agent/commit/e4945b1d22fbc14adcfea3590b6dc3ffef021585))
* **codex:** rename codex_hooks → hooks and migrate deprecated key ([f3e6474](https://github.com/JK-AJAE/oh-my-agent/commit/f3e64740724b2a50a4781d09bfec034ee90dbcaf))
* **docs:** clean up unused import and any-typed test fixtures ([05cc267](https://github.com/JK-AJAE/oh-my-agent/commit/05cc2674fc85dae259fdb896017edbadab80e82b))
* **docs:** normalize i18n-drift paths to POSIX on Windows ([5184bda](https://github.com/JK-AJAE/oh-my-agent/commit/5184bda30111c99566d849f5d79e2604a1f6be05))
* **docs:** normalize path separator on Windows for generated/ exclusion ([b85575e](https://github.com/JK-AJAE/oh-my-agent/commit/b85575e5b68fe6e8d3665698dc7f62408a2bdbd2))
* **docs:** reduce extractor false positives and add resolve fallback prefixes ([e863875](https://github.com/JK-AJAE/oh-my-agent/commit/e86387594a82674dfbd4ff4671ab80a6dcdb8623))
* **docs:** scope script refs to inline code and walk all ancestors ([01bd8ec](https://github.com/JK-AJAE/oh-my-agent/commit/01bd8ecbaa4d62630513c42b2a5a3e1dbd82d249))
* **doctor:** align unresponsive CLI test with 5s probe timeout ([4464048](https://github.com/JK-AJAE/oh-my-agent/commit/44640485f1a0910686391a052a661b2cd53cc914))
* **doctor:** bound CLI version probe with spawn timeout race ([edcf523](https://github.com/JK-AJAE/oh-my-agent/commit/edcf523f384136d0838a881144428ed41042c5c4))
* **doctor:** increase CLI probe timeout to 5s ([61dea9d](https://github.com/JK-AJAE/oh-my-agent/commit/61dea9dd2b4c7fc5bccbe31fde6964f6d8cc6587))
* **doctor:** raise vitest timeout for 5s CLI probe test ([80d380c](https://github.com/JK-AJAE/oh-my-agent/commit/80d380c4bb1949e0a2b96ce0fbcf92583bff3921))
* **doctor:** satisfy tsc in vendor doc test helper ([e559236](https://github.com/JK-AJAE/oh-my-agent/commit/e5592360b512f5492b6e958dff66ad054cbc1246))
* **grok:** add grok to RuntimeVendor and harden parser/renderer for tsc ([ec2cfd3](https://github.com/JK-AJAE/oh-my-agent/commit/ec2cfd308c3d5f26dc16569e21df6ebee640c581))
* **hooks/keyword-detector:** align CLI-invocation guard with vendor source of truth ([3c469dd](https://github.com/JK-AJAE/oh-my-agent/commit/3c469dd3687d7aedc16ca86368c24f50a74791e2))
* **hooks/keyword-detector:** close fullwidth/hyphen bypasses and add CLI invocation guard ([3dfc2dc](https://github.com/JK-AJAE/oh-my-agent/commit/3dfc2dc1d3998e29b1dc9223de237a3baf01b78c))
* **hooks/keyword-detector:** require explicit CLI signal for oma-family brands ([9be137a](https://github.com/JK-AJAE/oh-my-agent/commit/9be137a2761748d158f5e26fd0fcf0c45d98cf03))
* **hooks:** inject SKILL.md for explicit Claude slash skills ([daaa41d](https://github.com/JK-AJAE/oh-my-agent/commit/daaa41d2b3027fd1cda498cc8a81aa3c90d81ea6))
* **hooks:** normalize skill paths to POSIX form for Windows CI ([96a0044](https://github.com/JK-AJAE/oh-my-agent/commit/96a004436e6488b7e85b6af70ca591bf87d187e1))
* **hooks:** suppress ralph false-positive on meta-discussion prompts ([88307cf](https://github.com/JK-AJAE/oh-my-agent/commit/88307cff4a297e0ae4d850a35489a34fd6b35ff6))
* **image:** drop unused config arg from AntigravityProvider call ([eb350d4](https://github.com/JK-AJAE/oh-my-agent/commit/eb350d44f5067bb12b04bd8e4927d5dde8156226))
* **install:** honor --yes on `oma install` subcommand ([010e1dc](https://github.com/JK-AJAE/oh-my-agent/commit/010e1dc18a67f22eeec9ca4c96a2334cb7d07e2c))
* **install:** release install lock on early exit and signals ([e2e2814](https://github.com/JK-AJAE/oh-my-agent/commit/e2e2814b76e554c46deea3ffcc0688764d723597))
* **link:** generate copilot workflow prompts on oma link ([10e3c88](https://github.com/JK-AJAE/oh-my-agent/commit/10e3c88041d856a9729b4c5f33eda6458184da92))
* **mcp:** switch serena context from antigravity to ide ([163a6f2](https://github.com/JK-AJAE/oh-my-agent/commit/163a6f2143883124d02046a83765e2d1552bd08e))
* **migrations:** null-guard regex match result in 010 ([1b3cda3](https://github.com/JK-AJAE/oh-my-agent/commit/1b3cda3a2f2ea7404f76b16d8d8d48dae482608e))
* **repo:** force LF line endings to unblock Windows CI lint ([78e83a4](https://github.com/JK-AJAE/oh-my-agent/commit/78e83a48d6c267a94cec0c673713ceb9ea33f173))
* restore missing fields in claude-plugin manifest ([38dfbc5](https://github.com/JK-AJAE/oh-my-agent/commit/38dfbc57347916d1d0722711ecf132c6085f8259))
* **scm:** quote skill description frontmatter ([2a225df](https://github.com/JK-AJAE/oh-my-agent/commit/2a225df7dd5d39d3df39ff6029bda0c8a1919522))
* **skills/oma-frontend:** correct a11y anti-patterns in Card snippet ([a596060](https://github.com/JK-AJAE/oh-my-agent/commit/a59606075ef3bbc0dae57dfde196573bbfc3f0fe))
* **slide:** correct blank/collided/cropped merged viewer, bundle, and PDF ([fa99c3c](https://github.com/JK-AJAE/oh-my-agent/commit/fa99c3c77158f8f26931347747dc961748d4c4d1))
* **slide:** drop trailing blank page in PDF export ([34697d7](https://github.com/JK-AJAE/oh-my-agent/commit/34697d7f5154ec8afb08b778149d45ef1cfd2f3b))
* **slide:** render blank deck when deck-stage.js loads in &lt;head&gt; ([53f590e](https://github.com/JK-AJAE/oh-my-agent/commit/53f590ef366a1b4f8040ba406a1bd5fd4f5c1a70))
* **slide:** repair corrupt editor /screenshot dataUrl ([a66f920](https://github.com/JK-AJAE/oh-my-agent/commit/a66f920d21cd85e7adf79e2aaf4fb32432433503))
* **stats:** cache byVendor entry to satisfy noUncheckedIndexedAccess ([5abbf22](https://github.com/JK-AJAE/oh-my-agent/commit/5abbf2282f3862948c6a1759ba2bda1d258f90a7))
* **stats:** pad before color so ANSI codes don't break table width ([e24d833](https://github.com/JK-AJAE/oh-my-agent/commit/e24d833c84ad7b2b11fe00ee5cbcbd6254d795b2))
* **test:** normalize Windows backslashes in session-cost fs mocks ([17ea918](https://github.com/JK-AJAE/oh-my-agent/commit/17ea9182978acf2606b2347b08eb3de6218d5718))
* **test:** satisfy SpawnSyncReturns typing in cursor recap tests ([847e41c](https://github.com/JK-AJAE/oh-my-agent/commit/847e41c407121fe08f85a53aa1fc04a899df94a6))
* **test:** stub install_* functions in install-sh main pipe test ([e7af667](https://github.com/JK-AJAE/oh-my-agent/commit/e7af6677bcdb54b9cbcb79fab32de737ba1c1eba))
* **test:** use POSIX paths for direct mock store access ([0f0994a](https://github.com/JK-AJAE/oh-my-agent/commit/0f0994a999a51de3a7dd54bc6333bbc21df27918))
* **typecheck:** resolve @types/node v24/v25 conflict and strict test errors ([3ec0255](https://github.com/JK-AJAE/oh-my-agent/commit/3ec02552a1a588583b1c140e46733dfae16e7d4c))
* **verify:** replace globSync with deterministic matcher for hidden dirs ([b3b6401](https://github.com/JK-AJAE/oh-my-agent/commit/b3b64014fae90e433d2bbf21c2b92f3acabf98f8))


### Performance

* **web:** enable Docusaurus Faster (Rspack/SWC) and drop webpack override ([139378f](https://github.com/JK-AJAE/oh-my-agent/commit/139378f497531c677a8e62136c445a59bb4e5881))


### Refactoring

* **cli:** consolidate vendor list to a single source of truth ([ef03ac4](https://github.com/JK-AJAE/oh-my-agent/commit/ef03ac4f558aad0e7e8b9266fb4624bb22ec7ffe))
* **cli:** drop deprecated gemini from user-facing help text ([e2ea553](https://github.com/JK-AJAE/oh-my-agent/commit/e2ea553c6b6c2b8a3ee78ac68282b570e3014e04))
* **cli:** merge cli-kit/ into utils/ ([71bf0b9](https://github.com/JK-AJAE/oh-my-agent/commit/71bf0b94e603e27837195f312d2566843ec0553a))
* **cli:** move stats metrics to .agents/state ([1983d4d](https://github.com/JK-AJAE/oh-my-agent/commit/1983d4d6dcf7e5e545948efc381b3769bd65df16))
* **cli:** remove oma export command ([f2cb7a7](https://github.com/JK-AJAE/oh-my-agent/commit/f2cb7a75d8b06009743b0422685a1e57de8c3b05))
* **cli:** rename model preset keys (claude-only→claude, antigravity→mixed) ([681042d](https://github.com/JK-AJAE/oh-my-agent/commit/681042d60a0912a5f7f80ebcbfcb46459e438e0a))
* **cli:** tighten lint hygiene, replace shell pipeline, modernize tests ([07fa9ba](https://github.com/JK-AJAE/oh-my-agent/commit/07fa9bad519a4d9777fa79ad1d1db4cc6927d0f5))
* **hooks:** extract state snapshot rendering to vendor-renderer ([570b2d2](https://github.com/JK-AJAE/oh-my-agent/commit/570b2d2142d97c8d6ca5fcfa7d128186b98d94b8))
* **hooks:** split types.ts into types-only + fs-utils + hook-output ([e3f48f1](https://github.com/JK-AJAE/oh-my-agent/commit/e3f48f1886896907a7d2bd5539d31d07fa9f0a5d))
* **io:** split runtime-dispatch and add cursor vendor support ([5f83f79](https://github.com/JK-AJAE/oh-my-agent/commit/5f83f79658fbfb37d5ad61fb84d105a140ac07cc))
* **link:** promote link() to vendor reconciliation kernel ([9e8a0b1](https://github.com/JK-AJAE/oh-my-agent/commit/9e8a0b10a9fb58b75192933ac68f8177c0a4c304))
* **oma-frontend:** drop low-value resources, hoist stack files inline ([6ea9398](https://github.com/JK-AJAE/oh-my-agent/commit/6ea93988ddfbfb3f70a5d8b621a992b09fe6e88f))
* **skills:** make intent-rules and examples english-only ([0f14076](https://github.com/JK-AJAE/oh-my-agent/commit/0f14076bccaa5802e59d633897bb6bcbfc9be4b1))
* **skills:** rename createCliSymlinks → createVendorSymlinks, add Qwen ([5fb7b6e](https://github.com/JK-AJAE/oh-my-agent/commit/5fb7b6e3820502a1340ed299c6eed6b40cef7efb))
* **update,install:** delegate vendor write to link kernel ([30d72af](https://github.com/JK-AJAE/oh-my-agent/commit/30d72afcef64e7c54a57269f06906a9ac0ab7760))
* **vendors:** unify apply&lt;Vendor&gt;&lt;Subject&gt; naming convention ([51deebb](https://github.com/JK-AJAE/oh-my-agent/commit/51deebb348479fa619d5a418490041f4af17b009))


### Documentation

* **academic-writer:** reframe HD-grade as publication-grade ([27150c0](https://github.com/JK-AJAE/oh-my-agent/commit/27150c0ba5a2701c4a4dd11378f640efd8b2fb1a))
* add CITATION.cff with release-please auto-versioning ([f081b04](https://github.com/JK-AJAE/oh-my-agent/commit/f081b048efa685ea0acb46032ecf8283cea59909))
* add grok to model_preset lists in alphabetical order ([7ef90af](https://github.com/JK-AJAE/oh-my-agent/commit/7ef90afd553f107e939a4d515eda2850e9319e8d))
* add oma-slide skill entry to README agent tables ([80d7e38](https://github.com/JK-AJAE/oh-my-agent/commit/80d7e38fb02d27f3844bbe1ed370fcc804e4512b))
* **api-contracts:** align _shared/api-contracts path to _shared/core/api-contracts ([1edd5bf](https://github.com/JK-AJAE/oh-my-agent/commit/1edd5bf96e8ef30e8e6b7b36e6ba8ec407ff40a4))
* **benchmarks:** frame oma's lint -5 as intentional design principle ([3512aae](https://github.com/JK-AJAE/oh-my-agent/commit/3512aae154942556b239818e2dfde51d062a36ca))
* **benchmarks:** re-capture oma + omc screenshots at consistent viewport ([fd0a74d](https://github.com/JK-AJAE/oh-my-agent/commit/fd0a74d11db604b928abd0f7f22b1c6a7faf0b67))
* **claude:** regenerate CLAUDE.md rules table ([a7771db](https://github.com/JK-AJAE/oh-my-agent/commit/a7771dbe53c6a79316a8e2f7d7a9c465111f38ce))
* **claude:** reorder rules table by usage frequency ([da8e196](https://github.com/JK-AJAE/oh-my-agent/commit/da8e196eabc2e6c777d08aff4d3144ba7350f3f5))
* **core:** update auto-generated agent tables ([bba294f](https://github.com/JK-AJAE/oh-my-agent/commit/bba294faa8ea88fb2dfa22d376d5166865f521c2))
* drop hardcoded skill count and stale subagent paragraph ([424824b](https://github.com/JK-AJAE/oh-my-agent/commit/424824b1502f7183e31b4de6d32ae84111d51726))
* global-install + oma-config-semantics guides with 10-locale i18n ([b618fc5](https://github.com/JK-AJAE/oh-my-agent/commit/b618fc52a9d467699f9a7cf052343e4c9a804eb0))
* list cursor-only preset across guides and i18n locales ([afe62b4](https://github.com/JK-AJAE/oh-my-agent/commit/afe62b481a2b75f0bfe2e4a14aaa6660ab1dbedc))
* **oma-docs:** sync skill and ARCHITECTURE to no-LLM-call pattern ([e38dc57](https://github.com/JK-AJAE/oh-my-agent/commit/e38dc57f7269c558c0d12e6a390047c799879e6e))
* **oma-pm:** unify plan secondary output to result-pm.md ([f797932](https://github.com/JK-AJAE/oh-my-agent/commit/f797932fcb9ff85bccbd5dfef0489310b1a2fe27))
* **oma-slide:** default decks to session result paths ([bdec8c4](https://github.com/JK-AJAE/oh-my-agent/commit/bdec8c4a58beb000aee8fec1bf79037e2fd9b8f4))
* **readme:** add oma-academic-writer, oma-market, oma-voice rows ([e2598c9](https://github.com/JK-AJAE/oh-my-agent/commit/e2598c9c2255fa56f6156e9e527df9034371cd7f))
* **readme:** add oma-docs row to skill table in all locales ([7dea938](https://github.com/JK-AJAE/oh-my-agent/commit/7dea9388d3d1356a44b0cff223744729069a1a3a))
* **readme:** cite scaling-laws-of-skills preprint ([1611b52](https://github.com/JK-AJAE/oh-my-agent/commit/1611b520933bc0e03afb51b85431388bbb3e104e))
* **readme:** drop em dashes from agent team table ([c35a051](https://github.com/JK-AJAE/oh-my-agent/commit/c35a051ce40b0d845ccc2c5cbc519e073c05b807))
* **readme:** drop redundant '(Vercel deepsec)' parenthetical ([3901bb5](https://github.com/JK-AJAE/oh-my-agent/commit/3901bb577e9292020d97f16a925a1b688cf1f465))
* **readme:** hide oma-coordination from agent team table ([817377e](https://github.com/JK-AJAE/oh-my-agent/commit/817377eb03eab6a320d448011d93772a8cd49928))
* **readme:** list cursor-only preset in per-agent-models section ([230daef](https://github.com/JK-AJAE/oh-my-agent/commit/230daef0a68294270cd9a7eb210a2d679787511b))
* **readme:** rewrite oma-docs row with sibling-matched form across locales ([254aa80](https://github.com/JK-AJAE/oh-my-agent/commit/254aa80f38ff7b1799b3df8c1cbe7c8e9e697217))
* **readme:** sort CLI examples alphabetically and localize ([6a499b3](https://github.com/JK-AJAE/oh-my-agent/commit/6a499b324132b1e1bd0714fc32be7856d33ee28e))
* **readme:** surface verify, quota_cap, ralph JUDGE, Exploration Loop, monorepo routing ([2558fb1](https://github.com/JK-AJAE/oh-my-agent/commit/2558fb103cc185bd35d01d567226e3a081ddfc3c))
* **readme:** translate agent compatibility table across locales ([f5716ae](https://github.com/JK-AJAE/oh-my-agent/commit/f5716aed2ae69cf55bd745447a33bf2ec9613126))
* regenerate vendor guides via oma link ([8e670d4](https://github.com/JK-AJAE/oh-my-agent/commit/8e670d4497171e51494e76898c721cd6281d7d13))
* remove deprecated gemini from vendor and preset listings ([71915ff](https://github.com/JK-AJAE/oh-my-agent/commit/71915ff65a064730a7cdc753625f6c028ed662e6))
* reword agent table descriptions into plain sentences ([34d4e94](https://github.com/JK-AJAE/oh-my-agent/commit/34d4e940ec71c175738c72c51fabd1132096cd6d))
* **skills/oma-translator:** add sibling-pattern check and mechanical-swap guard ([148e50a](https://github.com/JK-AJAE/oh-my-agent/commit/148e50a609dbadd4e91564cd0d607bd275ae3a07))
* **skills:** cross-link observability handoffs across 8 skills ([6d5e99f](https://github.com/JK-AJAE/oh-my-agent/commit/6d5e99f265e2e3073bf78b54f1f4d161fad69b20))
* sync quick start + installation docs for serena bootstrap ([80be2a2](https://github.com/JK-AJAE/oh-my-agent/commit/80be2a2e7228bfb9008c5237091f88d6c91065b4))
* trim apm mechanism note and swap gemini for cursor in vendor list ([dd1d77f](https://github.com/JK-AJAE/oh-my-agent/commit/dd1d77f4e61d767b8f58163df5b36383f2cd87dc))
* update preset name references to new vendor scheme ([2f49afb](https://github.com/JK-AJAE/oh-my-agent/commit/2f49afbab98e733fccef180cd43e1b25d46c4487))
