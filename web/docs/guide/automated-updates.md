...
The oh-my-agent GitHub Action (`JK-AJAE/oma-update-action@v1`) automatically updates your project's agent skills by running `oma update` in CI. It supports two modes: creating a pull request for review, or committing directly to a branch.
