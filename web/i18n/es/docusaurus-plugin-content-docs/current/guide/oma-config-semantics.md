...
| `serena.auto_update` | Sí | Actualiza `serena-agent` durante `oma update` (`uv tool upgrade serena-agent --prerelease=allow`). |
...
| `serena.auto_update` | `true` | Ambos archivos ausentes o falta la clave |
