...
<strong>& thêm</strong><br/>
<sub><a href="./SUPPORTED_AGENTS.md">ma trận hỗ trợ →</a></sub>
</td>
</tr>
</table>
...
**model theo từng agent**: mỗi agent có thể trỏ tới model và `effort` riêng thông qua `.agents/oma-config.yaml`. Có sẵn sáu runtime profiles: `claude`, `codex`, `gemini`, `qwen`, `cursor`, `mixed`. Kiểm tra ma trận auth đã resolve bằng `oma doctor --profile`. Hướng dẫn đầy đủ: [web/docs/guide/per-agent-models.md](../web/docs/guide/per-agent-models.md).

## Tại sao chọn oh-my-agent?

> [Đọc thêm lý do →](https://github.com/JK-AJAE/oh-my-agent-custom/issues/155#issuecomment-4142133589)
...
- **[Tài liệu web](https://JK-AJAE.github.io/oh-my-agent/)**: hướng dẫn, tutorial và CLI reference
...
> ```
>
> Thử template starter tối ưu của chúng tôi: [fullstack-starter](https://github.com/JK-AJAE/fullstack-starter)
...
[Trở thành nhà tài trợ →](https://github.com/sponsors/JK-AJAE)
