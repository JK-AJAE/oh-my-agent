...
| **oma-deepsec** | Агентный сканер уязвимостей (Vercel deepsec), PR-шлюз, собственные matcher'ы |
...
| 4 | `/deepsec` | Глубокое агентное сканирование безопасности (Vercel deepsec) |
