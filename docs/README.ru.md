...
**модели по агенту**: каждый агент может указывать собственную модель и `effort` через `.agents/oma-config.yaml`. Из коробки доступны шесть runtime profiles: `claude`, `codex`, `gemini`, `qwen`, `cursor`, `mixed`. Проверьте итоговую auth-матрицу командой `oma doctor --profile`. Полное руководство: [web/docs/guide/per-agent-models.md](../web/docs/guide/per-agent-models.md).

## Почему oh-my-agent?

> [Подробнее →](https://github.com/JK-AJAE/oh-my-agent-custom/issues/155#issuecomment-4142133589)
...
- **[Веб-документация](https://JK-AJAE.github.io/oh-my-agent/)**: гайды, туториалы и справочник CLI
...
> ```
>
> Попробуйте наш оптимизированный стартовый шаблон: [fullstack-starter](https://github.com/JK-AJAE/fullstack-starter)
...
[Стать спонсором →](https://github.com/sponsors/JK-AJAE)
