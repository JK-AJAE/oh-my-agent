...
|-----------|----------|-----------|
| **S**imple | Can it be pronounced in 3 seconds? No need to ask for spelling? | |
| **M**emorable | Can you remember it the day after hearing it once? | |
| **I**mage-evoking | Does it conjure a specific image or emotion? | |
| **L**egally available | Can it be trademarked? Is a domain available? | |
| **E**xpandable | Will the name still work as the business grows? | |
...
- [ ] Search national trademark database for similar marks
- [ ] USPTO (US) — if planning global expansion
- [ ] Check availability of major social media handles
- [ ] Screen for negative meanings in other languages (minimum English/Chinese/Japanese/Spanish)
- [ ] Check for potential confusion with competitor names
